...
## When these servlets can be useful
Whit just these two servlets I can work on millions of documents stored in Apache Jackrabbit OAK, for example executing less than 20 lines of Pyhton code, like these: 
