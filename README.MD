...
- Using the Apache Jackrabbit OAK NodeIterator.getSize() method; in Apache Jackrabbit OAK implementation, this methods provide a valid result just if the **Fast return size** is enabled (OSGI configuration with PID org.apache.jackrabbit.oak.query.QueryEngineSettingsService)
...
Whit just these two servlets I can now analyze millions of documents stored in Apache Jackrabbit OAK, for example executing less than 20 lines of Pyhton code, like these: 
