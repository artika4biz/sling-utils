...
- **NodeCount**: A simple servlet that provides results count of a SQL-2 query. JCR does not provide a "count(*)" function. In addition the Apache Jackrabbit OAK getNodes.getSize() method returns -1 in case **Fast return count** in org.apache.jackrabbit.oak.query.QueryEngineSettingsService is false; in this case it is necessary to count each returned node
<img width="886" alt="image" src="https://user-images.githubusercontent.com/18739184/164772224-ce8355d3-3f11-4667-8ce3-6beced9c86dc.png">
- .  [http://localhost:8080/v1/count?sql=select * from [oak:Unstructured] as n where isdescendantnode(n,'/data/cassazione') and id is not null]: <img width="1210" alt="image" src="https://user-images.githubusercontent.com/18739184/163595003-fb095726-d219-4490-95ae-ab91a41c0643.png">
